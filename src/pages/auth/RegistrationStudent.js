...
const StudentRegistration = () => {
    ...
    {server_error.tc ? console.log(server_error.tc[0]) : ""} */}
        <Box component='form' noValidate sx={{ mt: 1 }} id='registration-form' onSubmit={handleSubmit}>
            ...
            <TextField margin='normal' required fullWidth id='hostel' name='Hostel' label='Hostel' type='text' />
            {server_error.name ? <Typography style={{ fontSize: 12, color: 'red', paddingLeft: 10 }}>{server_error.hostel[0]}</Typography> : ""}
            <TextField margin='normal' required fullWidth id='roll_number' name='roll_number' label='Roll Number' />
            {server_error.name ? <Typography style={{ fontSize: 12, color: 'red', paddingLeft: 10 }}>{server_error.Roll_Number[0]}</Typography> : ""}
            <TextField margin='normal' required fullWidth id='room_number' name='room' label='Room Number' />
            {server_error.name ? <Typography style={{ fontSize: 12, color: 'red', paddingLeft: 10 }}>{server_error.Room_Number[0]}</Typography> : ""}
