...
import { useGetroomdetailsMutation } from '../../services/userAuthApi';

const MarkAbsent = () => {
    const [server_error, setServerError] = useState({})
    const navigate = useNavigate();
    const [getroomdetails, { isLoading }] = useGetroomdetailsMutation()
    ...
    const handleSubmit = async (e) => {
        ...
        const res = await getroomdetails({ actualData, access_token })
        if (res.error) {
