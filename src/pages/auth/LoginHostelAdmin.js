...
import { useLoginHostelAdminMutation } from '../../services/userAuthApi';

const HostelAdminLogin = () => {
    const [server_error, setServerError] = useState({})
    const navigate = useNavigate();
    const [loginHostelAdmin, { isLoading }] = useLoginHostelAdminMutation()
    ...
    const handleSubmit = async (e) => {
        ...
        const res = await loginHostelAdmin(actualData)
        if (res.error) {
