...
import "./staticfiles/attendance-first-style.css";
const HostelFirstFloor = () => {
  ...
  useEffect(() => {
    const generateButtons = async () => {
      ...
      for (let roomNumber = 101; roomNumber <= 184; roomNumber++) {
  ...
  return (
    <>
      <div class="first-floor-container">
        <header class="first-floor-header">
          <div class="dashboard-button-first-floor">
            <button
...
export default HostelFirstFloor;
