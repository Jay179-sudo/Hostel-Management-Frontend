...
import "./staticfiles/attendance-second-style.css";
const HostelSecondFloor = () => {
  ...
  useEffect(() => {
    const generateButtons = async () => {
      ...
      for (let roomNumber = 201; roomNumber <= 284; roomNumber++) {
  ...
  return (
    <>
      <div className="third-floor-container">
        ...
        <h2 className="attendance-heading-h2">Second Floor</h2>
        <div className="second-floor-main">{buttons}</div>
      </div>
    </>
  );
};

export default HostelSecondFloor;
